...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_id", type=str, default='1', help="Name for this model instance. "
                        ...
                        "from scratch.")
    parser.add_argument("--clean_data_root", type=Path, required=True, help="Path to the output "
                        "directory of encoder_preprocess.py. If you left the default output "
                        "directory when preprocessing, it should be <datasets_root>/SV2TTS/encoder/.")
    ...
    parser.add_argument("-u", "--umap_every", type=int, default=100, help="Number of steps between "
                        "updates of the umap projection. Set to 0 to never update the projections.")
    parser.add_argument("-s", "--save_every", type=int, default=500, help="Number of steps between "
                        "updates of the model on the disk. Set to 0 to never save the model.")
    parser.add_argument("-b", "--backup_every", type=int, default=7500, help="Number of steps between "
